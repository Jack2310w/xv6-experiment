...
/*
static void
ping_send(uint16 sport, uint16 dport, int attempts)
{
  int fd;
...
static void ping_recv(uint16 sport, uint16 dport, int attempts)
{
  int fd;
  // char *obuf = "a message from xv6!";
  uint32 dst;
